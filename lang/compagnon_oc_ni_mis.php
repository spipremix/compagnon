...
// extrait automatiquement de http://trad.spip.net/tradlang_module/compagnon?lang_cible=oc_ni_mis
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'c_article_redaction_redacteur_texte' => 'Per proupausa lou vouòstre article ai aministratour dóu sit e ai autre redatour,
		en lou cadre sus lou coustà, cambiàs « en cours de redacioun » da « proupausat da publicacioun ».',
	'c_article_redaction_texte' => 'Da publicà aquel article sus lou sit public, cau cambià lou siéu statut.
		En lou cadre sus lou coustà, cambiàs « en cours de redacioun » da « publicat en ligna ».',
	...
	'c_rubrique_publier_texte' => 'Una rùbrica es visible sus lou sit public
		...
		Creàs pi un article. Poudès lou faire despì aquela pàgina, souta lou descritiéu de la vouòstra rùbrica.',
	'c_rubriques_creer' => 'Creàs una premièra rùbrica !',
	...
	'explication_activer_compagnon' => 'Lou coumpàgnou ajustà dei coumentari sus certeni pàgina
			de l’espaci privat da ajudà a pilha SPIP en main. Vouriàs l’ativà ?',
	'explication_reinitialiser_compagnon' => 'Lu message jà vist d’un autour seran plus afichat après.
			Vouriàs reinicialisat aquelu message ?',
